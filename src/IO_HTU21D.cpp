...
float IO_HTU21D::readHumidity(void)
{
...
//Returns 998 if I2C timed out 
//Returns 999 if CRC is wrong
float IO_HTU21D::readTemperature(void)
{
...
void IO_HTU21D::setResolution(byte resolution)
{
...
byte IO_HTU21D::read_user_register(void)
{
  byte userRegister;
...
//Give this function the 2 byte message (measurement) and the check_value byte from the IO_HTU21D
...
byte IO_HTU21D::check_crc(uint16_t message_from_sensor, uint8_t check_value_from_sensor)
{
